...
public class DBservice {
    ...
    @Autowired
    private ItemPedidoRepositores itemPedidoRepositores;
    ...
    public void instantiateTestDataBase() throws ParseException {
        ...
        Categoria cat8 = new Categoria(null, "Texte");
        ...
        categoriaRepositore.saveAll(Arrays.asList(cat1, cat2, cat3, cat4, cat5, cat6, cat7, cat8));
        produtoRepositore.saveAll(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11));
        estadoRepositore.saveAll(Arrays.asList(est1, est2));
        cidadeRepositore.saveAll(Arrays.asList(c1, c2, c3));

        Cliente cli1 = new Cliente(null,"Maria silva", "willifran@gmail.com","36378912377", TipoCliente.PESSOAFISICA);
        ...
        pedidoRepositore.saveAll(Arrays.asList(ped1, ped2));

        pagamentoRepositore.saveAll(Arrays.asList(pagto1, pagto2));
        ...
        itemPedidoRepositores.saveAll(Arrays.asList(ip1, ip2, ip3));
    }
}
